		   ...
		   struct ktermios *old)
{
	...
	//printk("termios %d, %d, 0x%x\n", (termios->c_cflag & CRTSCTS), sport->have_rtscts, port->rs485.flags);
		...
		struct platform_device *pdev)
{
	...
	printk ("probe_dt: 0x%x %d, %d\n", sport->port.rs485.flags, sport->have_rtscts, sport->have_rtsgpio);
